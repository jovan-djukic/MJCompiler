...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Jan 03 18:17:47 CET 2017
  */
      ...
      switch (CUP$Parser$act_num)
		...
		Obj rightExpression = (Obj)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
									...
									if (leftExpression != null && !leftExpression.equals(SymbolTable.noObj) && !leftExpression.getType().equals(SymbolTable.intType)) {
										parser.report_semantic_error("leftExpression " + leftExpression.getName() + " is not of type int", leftExpressionleft);
										error = true;
									}
		...
		Obj expression = (Obj)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
							...
							} else if (!expression.equals(SymbolTable.noObj) && !designator.equals(SymbolTable.noObj) && !expression.getType().assignableTo(designator.getType())) {
